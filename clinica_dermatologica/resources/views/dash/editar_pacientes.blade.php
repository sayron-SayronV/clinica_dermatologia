    ...
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          <form method="POST" id="frmnuevo" name="frmnuevo" action="/paciente/upd/{{ $pacientesArray['COD_PACIENTE'] }}" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="prim_nombre" name="prim_nombre" value="{{ $pacientesArray['PRI_NOMBRE'] }}" required="">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="prim_apellido" name="prim_apellido" value="{{ $pacientesArray['PRI_APELLIDO'] }}" required="">
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                <label>Género</label>
                <select class="form-control" style="width: 100%;" name="genero" value="{{ $pacientesArray['GENERO'] }}" required>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control" id="fech_nacimiento" name="fech_nacimiento" value="{{ date('Y-m-d', strtotime($pacientesArray['FECHA_NACIMIENTO'])) }}" required="">
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="num" class="form-control" id="edad" name="edad" value="{{ $pacientesArray['EDAD'] }}" required="" pattern="[1-9]+">
                <div class="valid-feedback">¡Ok válido!</div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="tipo_id" name="tipo_id" value="{{ $pacientesArray['TIPO_ID'] }}" required="">
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="num_id_pac" name="num_id_pac" value="{{ $pacientesArray['NUMERO_ID'] }}" required="">
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <select class="form-control" style="width: 100%;" name="estado" value="{{ $pacientesArray['ACTIVO_INACTIVO'] }}" required>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="tel_pac" name="tel_pac" value="{{ $pacientesArray['TELEFONO'] }}" required="">
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="direccion" name="direccion" value="{{ $pacientesArray['DIRECCION'] }}" required="">
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <select class="form-control" style="width: 100%;" name="departamento" value="{{ $pacientesArray['DEPARTAMENTO'] }}" required>
